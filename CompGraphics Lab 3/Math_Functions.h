...
BaryocentricPoint BaryocentricCoords(Vertex p, Triangle tri);
...
UINT ModulateColors(UINT color1, UINT color2)
{
	return 0;
}
...
BaryocentricPoint BaryocentricCoords(Vertex p, Triangle tri)
{
	...
	float alpha = ((p2.xyzw[1] - p3.xyzw[1]) * (p.xyzw[0] - p3.xyzw[0]) + (p3.xyzw[0] - p2.xyzw[0]) * (p.xyzw[1] - p3.xyzw[1])) / ((p2.xyzw[1] - p3.xyzw[1]) * (p1.xyzw[0] - p3.xyzw[0]) + (p3.xyzw[0] - p2.xyzw[0]) * (p1.xyzw[1] - p3.xyzw[1]));
	
	float beta = ((p3.xyzw[1] - p1.xyzw[1]) * (p.xyzw[0] - p3.xyzw[0]) + (p1.xyzw[0] - p3.xyzw[0]) * (p.xyzw[1] - p3.xyzw[1])) / ((p2.xyzw[1] - p3.xyzw[1]) * (p1.xyzw[0] - p3.xyzw[0]) + (p3.xyzw[0] - p2.xyzw[0]) * (p1.xyzw[1] - p3.xyzw[1]));
